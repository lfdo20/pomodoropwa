...
$(".display").on({
  mouseenter: function() {
  $('.display > h1').css({'textShadow' : '#0D233E 2px 2px 5px'});
},
  mouseleave: function(){
  $('.display > h1').css({'textShadow' : '#0D233E 0px 0px 0px'});
}
});

$(".fa-2x").on({
  mouseenter: function() {
  $(this).css({'textShadow' : '#0D233E 2px 2px 5px'});
},
  mouseleave: function(){
  $(this).css({'textShadow' : '#0D233E 0px 0px 0px'});
}
});
